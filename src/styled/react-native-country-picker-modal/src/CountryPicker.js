...
import {calcHeight} from '../../../config.js';
...
export default class CountryPicker extends Component {
  ...
  static renderImageFlag(cca2, imageStyle) {
    return cca2 !== '' ? (
      <Image
        style={[
          countryPickerStyles.imgStyle,
          imageStyle,
          {height: calcHeight(3), width: calcHeight(4.5)},
        ]}
      ...
      <View style={styles.itemCountry}>
        ...
        <View style={styles.itemCountryName}>
          <Text
            style={[
              styles.countryName,
              {fontSize: RFValue(14), fontFamily: 'Montserrat-Light'},
            ]}
            allowFontScaling>
