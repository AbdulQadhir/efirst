  ...
  <View style={styles.modalContent}>
    <View style={{flexDirection: 'row', padding: 7}}>
      <View
        ...
        <Text style={{fontSize: RFValue(17), fontFamily: 'Montserrat-Medium'}}>
          Terms and Condition
        </Text>
      </View>
      <TouchableOpacity
        ...
        <Icon
          style={{fontSize: RFValue(22), marginTop: calcHeight(1.2)}}
          name="md-close"
        />
      </TouchableOpacity>
    </View>
    <ScrollView>
      <View style={{padding: 20}}>
        <Text style={styles.txtNormal}>
          ...
          <Text style={styles.txtBold}>“https://app.efirst.ae”</Text> website
          and the <Text style={styles.txtBold}>“Efirst”</Text> mobile
          application (the "Service") operated by{' '}
        ...
        <Text style={styles.txtTitle}>Govt. fees and Service charges</Text>
        <Text style={styles.txtNormal}>
          Our charges includes Govt. fees which will be the exact charges
          mentioned{' '}
          <Text style={styles.txtRedUnderline}>
            as per the UAE government norms
          </Text>{' '}
          and there will a service charge which is mentioned separately with the
          price.
        </Text>
        <Text style={styles.txtTitle}>Purchases</Text>
        <Text style={styles.txtNormal}>
          ...
          your billing address. Credit card information is always encrypted
        ...
        <Text style={styles.txtNormal}>
          ...
          of facilitating payment and the completion of any Purchase. By
        ...
        <Text style={styles.txtNormal}>
          We reserve the right to refuse or cancel your order if we have reason,
          in our sole discretion, to suspect fraud or an unauthorized or illegal
        ...
        <Text style={styles.txtTitle}>Price Changes</Text>
        <Text style={styles.txtNormal}>
          <Text style={styles.txtBold}>Efirst</Text> in its sole discretion and
          at any time, may modify the prices for the Services. Any Service price
          change will become effective soon after we update it.
        </Text>
        <Text style={styles.txtNormal}>
          <Text style={styles.txtBold}>Efirst</Text> will provide you with a
          reasonable prior notice of any change in Subscription prices to give
          you an opportunity to terminate your Subscription before such change
          becomes effective.
        </Text>
        <Text style={styles.txtNormal}>
          Your continued use of the Service after the Subscription price change
          comes into effect constitutes your agreement to pay the modified
          Subscription price amount.
        </Text>

        <Text style={styles.txtTitle}>Refunds</Text>
        <Text style={styles.txtNormal}>
          Refunds are available in case your service requests are rejected due
          to any documents issues or any other.{' '}
          <Text style={styles.txtRedItalic}>
            To process your refund, we will be contacting by manually or you can
            send a message to the admin with your email and order number which
            you received to your email after purchase.
          </Text>
        </Text>
        <Text style={styles.txtNormal}>
          Certain refund requests may be considered by Efirst on a case-by-case
          basis and granted in sole discretion of Efirst.
        </Text>

        <Text style={styles.txtTitle}>Accounts</Text>
        <Text style={styles.txtNormal}>
        ...
        <Text style={styles.txtNormal}>
          ...
          offensive, vulgar or obscene. You expressly agree that we cannot be
          held liable for any loss or damage arising out of any
          misrepresentations you make in this regard.
        </Text>

        <Text style={styles.txtTitle}>Intellectual Property</Text>
        <Text style={styles.txtNormal}>
          The Service and its original content, features and functionality are
          and will remain the exclusive property of{' '}
          <Text style={styles.txtBold}>Efirst</Text> and its licensors. The
          Service is protected by copyright, trademark, and other laws of UAE.
          ...
          <Text style={styles.txtBold}>Efirst</Text>.
        </Text>
        <Text style={styles.txtNormal}></Text>
        ...
        <Text style={styles.txtTitle}>Links to Other Web Sites</Text>
        <Text style={styles.txtNormal}>
        ...
        <Text style={styles.txtTitle}>Disclaimer</Text>
        <Text style={styles.txtNormal}>
        ...
        <Text style={styles.txtNormal}>
          <Text style={styles.txtBold}>Efirst</Text> its subsidiaries,
          affiliates, and its licensors do not warrant that{' '}
          <Text style={styles.txtRedUnderline}>
            a) the Service will function within a time period, secure or
            available at any particular time or location;
          </Text>{' '}
          b) any errors or defects will be corrected; c) the results of using
          the Service will meet your requirements.
        </Text>
        <Text style={styles.txtTitle}>Governing Law</Text>
        <Text style={styles.txtNormal}>
        ...
        <Text style={styles.txtTitle}>Termination</Text>
        <Text style={styles.txtNormal}>
        ...
        <Text style={styles.txtTitle}>Changes</Text>
        <Text style={styles.txtNormal}>
