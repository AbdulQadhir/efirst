...
class App extends React.Component {
  ...
  const HideDateTimePicker = () => this.setState({IsDatePickerVisible: false});
      ...
      <View style={styles.body}>
        <View>
          <ScrollView
            ...
            <View style={{flexDirection:"row", justifyContent: "space-between", marginVertical:  calcWidth(3) }} >
              <ButtonSlim label="Open Services: 24" style={{ backgroundColor:"#47489f" }} />
              <ButtonSlim label="Completed Services: 5" style={{ backgroundColor:"#008837" }} />
              <ButtonSlim label="Rejected Services: 1" style={{ backgroundColor:"#ff0000" }} /> 
            </View>
            <Underline />
            <ProfileSectionHdr label={"Personal Details"} onSavePress={()=>alert("Saved")} />
            <View style={{ paddingHorizontal: calcWidth(2) }} >
              <LabelInput label="Birthday" />
              <Input2  style={{ marginVertical:0 }} 
                    onTouchStart={ShowDateTimePicker} value={dateFormat(this.state.dob)} />
              <LabelInput label="Gender" />
              <Input2  style={{ marginVertical:0 }} />
            </View>
            <ProfileSectionHdr label={"Contact Details"} onSavePress={()=>alert("Saved")} />
            <View style={{ paddingHorizontal: calcWidth(2) }} >
            ...
            <ProfileSectionHdr label={"Company Details"} onSavePress={()=>alert("Saved")} />
            <View style={{ paddingHorizontal: calcWidth(2) }} >
