...
import {InputSupport, ButtonNormal, SupportDetail} from "./uicomponents/components";
    ...
    <>
          <View style={styles.body} >
                <View style={styles.box}>
                    ...
                    <InputSupport placeholder="Message" multiline={true} style={{height: calcHeight(15)}} />
                </View>  
                ...
                <ScrollView style={styles.box}>
                    ...
                    <SupportDetail title="Address" data="jhgjksad lksdflskfn lskdfns skdfnlskf sdkjfslkf djskfsdkf"/>
                </ScrollView>
          </View>
    </>
  );
