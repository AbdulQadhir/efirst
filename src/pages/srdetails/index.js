    ...
    <>
          <View style={styles.body} >
                <View style={{flexDirection:'column',padding:20,flex:1}}>
                    ...
                    <SRDtDate label="Sep 18, 2019, 9.43 am" onRefresh={()=>alert("Refresh")} onChatPress={()=>alert("Chat")} />
                    <View style={{flexDirection:"row", justifyContent: "space-between", marginVertical:  calcWidth(1) }} >
                      <ButtonSlim onPress={()=>this.setTab(1)} label="Details" style={{ backgroundColor:this.state.selectedTab == 1 ? "#47489f" :"#f84563" }} />
                      <ButtonSlim onPress={()=>this.setTab(2)}  label="Documents" style={{ backgroundColor:this.state.selectedTab == 2 ? "#47489f" :"#f84563" }} />
                      <ButtonSlim onPress={()=>this.setTab(3)}  label="SR Details" style={{ backgroundColor:this.state.selectedTab == 3 ? "#47489f" :"#f84563" }} /> 
                    </View>
                    <View style={{flex:1}}>
